public class StarterModule{
    ...
    private final static int[] threeStagePokemon = new int[]{1, 4, 7, 10, 13, 16, 29, 32, 41, 43, 60, 63, 66, 69, 74, 79, 92, 116, 147, 152, 155, 158, 172, 173, 174, 179, 187, 246, 277, 280, 283, 290, 298, 341, 350, 364, 370, 382, 392, 395, 398};
    ...
    private final static int startIndex1 = 1481653;
    private final static int startIndex2 = 1482114;
    private final static int startIndex3 = 1482168;
    private final static int starterLevelIndex = 1481870;
    ...
    public void randomizeStartersAllPokemon(){
        //default randomization - starter is replaced by random value from All pokemon list
        setPokemon(startIndex1, editRom.chooseFromList(allPokemon));
        setPokemon(startIndex2, editRom.chooseFromList(allPokemon));
        setPokemon(startIndex3, editRom.chooseFromList(allPokemon));
        randomizeStarterLevel();
    }

    public void randomizeStartersAllPokemonNoLegendary(){
        //default randomization - starter is replaced by random value from All pokemon without legendaries list
        setPokemon(startIndex1, editRom.chooseFromList(allPokemonNoLegendary));
        setPokemon(startIndex2, editRom.chooseFromList(allPokemonNoLegendary));
        setPokemon(startIndex3, editRom.chooseFromList(allPokemonNoLegendary));
        randomizeStarterLevel();
        
    }

    public void randomizeStarterThreeStage(){
        //default randomization - starter is replaced by random value from 1-151.
        setPokemon(startIndex1, editRom.chooseFromList(threeStagePokemon));
        setPokemon(startIndex2, editRom.chooseFromList(threeStagePokemon));
        setPokemon(startIndex3, editRom.chooseFromList(threeStagePokemon));
        randomizeStarterLevel();
